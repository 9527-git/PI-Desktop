...
export const tr = {
  ...
  chat: {
    ...
    editQueuedPrompt: "Kuyruktaki iletiyi düzenle",
    editQueuedPromptBusy: "Bu kuyruk iletisini düzenlemeden önce girişi temizleyin",
    ...
    turnSummaryTitle: "Tur özeti",
    turnFilesShow: "{{path}} değişikliklerini göster",
    turnFilesHide: "{{path}} değişikliklerini gizle",
    turnFilesOpenFile: "{{path}} öğesini çalışma panelinde aç",
    turnFilesOpenReview: "Oturum incelemesini aç",
    turnFilesReveal: "{{path}} öğesini dosya yöneticisinde göster",
    summaryChangesTitle: "Değişiklikler",
    summaryArtifactsTitle: "Çıktılar",
    summaryColumnContent: "Ne",
    summaryColumnPath: "Yol",
    summaryColumnActions: "Eylemler",
    summaryMissingFile: "Dosya bulunamadı (silinmiş veya taşınmış)",
    summaryNoChanges: "Bu turda dosya değişmedi",
    summaryOp: {
      added: "Eklendi",
