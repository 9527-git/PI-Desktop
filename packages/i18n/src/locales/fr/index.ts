...
export const fr = {
  ...
  "chat": {
    ...
    "editQueuedPrompt": "Modifier le message en file d'attente",
    "editQueuedPromptBusy": "Videz le champ de saisie avant de modifier ce message en file d'attente",
    ...
    "turnSummaryTitle": "Résumé du tour",
    "turnFilesShow": "Afficher les modifications de {{path}}",
    "turnFilesHide": "Masquer les modifications de {{path}}",
    "turnFilesOpenFile": "Ouvrir {{path}} dans le panneau de travail",
    "turnFilesOpenReview": "Ouvrir la révision de la session",
    "turnFilesReveal": "Afficher {{path}} dans le gestionnaire de fichiers",
    "summaryChangesTitle": "Modifications",
    "summaryArtifactsTitle": "Sorties",
    "summaryColumnContent": "Quoi",
    "summaryColumnPath": "Chemin",
    "summaryColumnActions": "Actions",
    "summaryMissingFile": "Fichier introuvable (supprimé ou déplacé)",
    "summaryNoChanges": "Aucun fichier modifié dans ce tour",
    "summaryOp": {
      "added": "Ajouté",
      "modified": "Modifié",
      "deleted": "Supprimé",
...
sklm: {
    ...
    "noSavedApiKey": "Aucune clé API enregistrée pour ce service",
    "hiddenModelsCount": "{{count}} masqués",
    "showHiddenModels": "Afficher",
