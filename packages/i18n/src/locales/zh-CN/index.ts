...
export const zhCN = {
  ...
  chat: {
    ...
    resultContinue: "继续",
    turnSummaryTitle: "回合汇总",
    turnFilesShow: "显示 {{path}} 的变更",
    turnFilesHide: "隐藏 {{path}} 的变更",
    turnFilesOpenFile: "在工作面板中打开 {{path}}",
    turnFilesOpenReview: "打开会话审查",
    ...
    summaryMissingFile: "文件不存在（已删除或移动）",
    summaryNoChanges: "本回合没有文件变更",
    summaryOp: {
      added: "新增",
      modified: "修改",
      deleted: "删除",
