...
export const zhCN = {
  ...
  chat: {
    ...
    turnSummaryTitle: "本回合汇总",
    turnFilesShow: "展开 {{path}} 的改动",
    turnFilesHide: "收起 {{path}} 的改动",
    turnFilesOpenFile: "在工作面板打开 {{path}}",
    turnFilesOpenReview: "打开会话改动列表",
    turnFilesReveal: "在文件管理器中显示 {{path}}",
    summaryChangesTitle: "变更",
    summaryArtifactsTitle: "产出",
    summaryColumnContent: "内容",
    summaryColumnPath: "路径",
    summaryColumnActions: "操作",
    summaryMissingFile: "文件不存在（可能已被删除或移动）",
    summaryNoChanges: "本回合没有改动文件",
    summaryOp: {
      added: "新增",
      modified: "修改",
      deleted: "删除",
