export const en = {
  ...
  chat: {
    ...
    turnFilesShow: "Show changes for {{path}}",
    turnFilesHide: "Hide changes for {{path}}",
    turnFilesOpenFile: "Open {{path}} in the work panel",
    turnFilesOpenReview: "Open the session review",
    turnFilesReveal: "Show {{path}} in the file manager",
    summaryChangesTitle: "Changes",
    summaryArtifactsTitle: "Outputs",
    summaryColumnContent: "What",
    summaryColumnPath: "Path",
    summaryColumnActions: "Actions",
    summaryMissingFile: "File not found (deleted or moved)",
    summaryNoChanges: "No files changed in this turn",
    summaryOp: {
      added: "Added",
      modified: "Modified",
      deleted: "Deleted",
