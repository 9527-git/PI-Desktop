...
export const de = {
  ...
  "chat": {
    ...
    "editQueuedPrompt": "Nachricht in der Warteschlange bearbeiten",
    "editQueuedPromptBusy": "Leeren Sie zuerst die Eingabe, um diese Nachricht in der Warteschlange zu bearbeiten",
    ...
    "turnSummaryTitle": "Turn-Zusammenfassung",
    "turnFilesShow": "Änderungen für {{path}} anzeigen",
    "turnFilesHide": "Änderungen für {{path}} ausblenden",
    "turnFilesOpenFile": "{{path}} im Arbeitsbereich öffnen",
    "turnFilesOpenReview": "Sitzungsüberprüfung öffnen",
    "turnFilesReveal": "{{path}} im Dateimanager anzeigen",
    "summaryChangesTitle": "Änderungen",
    "summaryArtifactsTitle": "Ausgaben",
    "summaryColumnContent": "Was",
    "summaryColumnPath": "Pfad",
    "summaryColumnActions": "Aktionen",
    "summaryMissingFile": "Datei nicht gefunden (gelöscht oder verschoben)",
    "summaryNoChanges": "In diesem Turn wurden keine Dateien geändert",
    "summaryOp": {
      "added": "Hinzugefügt",
      "modified": "Geändert",
      "deleted": "Gelöscht",
