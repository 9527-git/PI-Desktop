...
export const de = {
  ...
  "chat": {
    ...
    turnSummaryTitle: "Zusammenfassung des Durchgangs",
    turnFilesShow: "Änderungen an {{path}} anzeigen",
    turnFilesHide: "Änderungen an {{path}} ausblenden",
    turnFilesOpenFile: "{{path}} im Arbeitsbereich öffnen",
    turnFilesOpenReview: "Sitzungsübersicht öffnen",
    turnFilesReveal: "{{path}} im Dateimanager anzeigen",
    summaryChangesTitle: "Änderungen",
    summaryArtifactsTitle: "Ergebnisse",
    summaryColumnContent: "Inhalt",
    summaryColumnPath: "Pfad",
    summaryColumnActions: "Aktionen",
    summaryMissingFile: "Datei nicht gefunden (gelöscht oder verschoben)",
    summaryNoChanges: "In diesem Durchgang wurden keine Dateien geändert",
    summaryOp: {
      added: "Neu",
      modified: "Geändert",
      deleted: "Gelöscht",
