...
export const es = {
  ...
  "chat": {
    ...
    "editQueuedPrompt": "Editar mensaje en cola",
    "editQueuedPromptBusy": "Vacía la entrada antes de editar este mensaje en cola",
    ...
    "turnFilesShow": "Mostrar cambios de {{path}}",
    "turnFilesHide": "Ocultar cambios de {{path}}",
    "turnFilesOpenFile": "Abrir {{path}} en el panel de trabajo",
    "turnFilesOpenReview": "Abrir la revisión de la sesión",
    "turnFilesReveal": "Mostrar {{path}} en el gestor de archivos",
    "summaryChangesTitle": "Cambios",
    "summaryArtifactsTitle": "Salidas",
    "summaryColumnContent": "Qué",
    "summaryColumnPath": "Ruta",
    "summaryColumnActions": "Acciones",
    "summaryMissingFile": "Archivo no encontrado (eliminado o movido)",
    "summaryNoChanges": "Ningún archivo cambió en este turno",
    "summaryOp": {
      "added": "Añadido",
      "modified": "Modificado",
      "deleted": "Eliminado",
...
sklm: {
    ...
    "selectAllModelsHint": "Marcar añade todos los modelos visibles; desmarcar los vacía: cada uno sigue en la lista y se puede restaurar.",
    "copyBaseUrl": "Copiar URL del endpoint",
