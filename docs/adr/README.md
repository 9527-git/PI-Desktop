...
| 0065 | Smooth shell layout and stream feedback | Accepted for implementation (clause 4 superseded by 0224) |
...
| 0224 | Keep the docked conversation composer in normal flow | Accepted (amends ADR 0065 clause 4 / D264) |
